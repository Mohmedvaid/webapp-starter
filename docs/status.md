...
**Last updated:** 2026-08-24, template rename and flag
...
|---|---|---|
| 2026-08-24 | GitHub repo renamed to webapp-starter, template flag on, naming generic except in commands | `3d7de11` `becb054` | main |
...
|---|---|---|
| 2026-08-24 | Renamed GitHub repo to webapp-starter, set is_template, verified a one-commit throwaway, genericized prose. Local folder still starter-template. | Phase 0 not started. Next session runs `_build/phase-0.md`. |
